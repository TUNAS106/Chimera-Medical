...
Each subtask must describe the actual work to perform. Do not phrase a subtask as an instruction to assign or delegate work, and do not include worker node IDs in subtask content. The workforce coordinator will handle assignment separately.
"""
